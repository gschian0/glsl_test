...
void main(){
    vec2 coord = 0.1*gl_FragCoord.xy / u_resolution*2.0 +vec2(5.25);
    float color = 0.0;
    ...
    color -= 8.*sin(coord.y*3.0*float(i))+0.2*cos(u_time+coord.x*2.0+0.3*sin(3.*coord.y*4.00+sin(coord.x+u_time)))-u_time/30.0;
